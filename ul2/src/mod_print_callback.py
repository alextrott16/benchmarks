...
class MixtureOfDenoisersPrinterCallback(Callback):
    ...
    def __init__(
        ...
        assert isinstance(self.tokenizer, (T5Tokenizer, T5TokenizerFast)), "Name of tokenizer must correspond to a T5 tokenizer."
    ...
    def init(self, state: State, logger: Logger) -> None:
        ...
        assert isinstance(hf_model, T5ForConditionalGeneration), "This class only works for `transformers.T5ForConditionalGeneration` models"
    ...
    def after_dataloader(self, state: State, logger: Logger) -> None:
        ...
        input_str, target_str, output_str = self._generate_input_target_output_strings(state.batch, state.model.model)
    ...
    def _generate_input_target_output_strings(self, batch: Dict[str, torch.TensorType], model: T5ForConditionalGeneration) -> List[str]:
